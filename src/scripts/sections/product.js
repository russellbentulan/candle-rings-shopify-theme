...
const classes = {
  hide: 'hide',
  itemCurrent: 'product-single__item--current',
};
...
const selectors = {
  ...
  itemCurrent: 'li.product-single__item--current',
  imageFeatured: 'product-single__featured-image'
};
...
register('product', {
  ...
  renderActiveThumbnail(id) {
    ...
    const activeParent = activeThumbnail.parentNode;
    const inactiveParent = inactiveThumbnail.parentNode;

    if (activeThumbnail === inactiveThumbnail) {
      return;
    }

    inactiveParent.classList.remove(classes.itemCurrent);
    activeParent.classList.add(classes.itemCurrent);
  ...
  renderFeaturedImage(id) {
    ...
    const activeParent = activeImage.parentNode;
    const inactiveParent = inactiveImage.parentNode;

    activeParent.classList.add(classes.hide);
    inactiveParent.classList.remove(classes.hide);
